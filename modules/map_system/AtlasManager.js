...
export class AtlasManager {
    ...
    async setBackgroundImage(imageUrl) {
        ...
        await this.lorebookManager.updateEntryContent(bookName, this.ATLAS_ENTRY_NAME, newAtlasData, true);
    ...
    async updateAtlas() {
        ...
        if (!bookName || !this.mapDataManager.isInitialized()) {
            ...
            if (bookName) {
                ...
                if (worldbook.some(e => e.name === this.ATLAS_ENTRY_NAME)) {
                    ...
                    await this.lorebookManager.updateEntryContent(bookName, this.ATLAS_ENTRY_NAME, emptyData, true);
                }
            }
            return;
        }
        ...
        if (!atlasEntry) {
            ...
            await this.lorebookManager.createEntry(bookName, {
                ...
                content: JSON.stringify(newAtlasData, null, 2),
                ...
                position: { type: 'before_character_definition', order: 0, role: 'system' } // High priority
            });
        } else {
            // Only update if content has actually changed
            if (atlasEntry.content !== JSON.stringify(newAtlasData, null, 2)) {
                await this.lorebookManager.updateEntryContent(bookName, this.ATLAS_ENTRY_NAME, newAtlasData, true);
            } else {
